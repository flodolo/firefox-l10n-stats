...
def main():
    ...
    locales = [
        'ach', 'af', 'an', 'ar', 'ast', 'az', 'be', 'bg', 'bn', 'bo', 'br',
        'brx', 'bs', 'ca', 'ca-valencia', 'cak', 'ckb', 'cs', 'cy', 'da', 'de',
        'dsb', 'el', 'en-CA', 'en-GB', 'eo', 'es-AR', 'es-CL', 'es-ES',
        'es-MX', 'et', 'eu', 'fa', 'ff', 'fi', 'fr', 'fy-NL', 'ga-IE', 'gd',
        'gl', 'gn', 'gu-IN', 'he', 'hi-IN', 'hr', 'hsb', 'hu', 'hy-AM', 'hye',
        'ia', 'id', 'is', 'it', 'ja', 'ka', 'kab', 'kk', 'km', 'kn', 'ko',
        'lij', 'lo', 'lt', 'ltg', 'lv', 'meh', 'mk', 'mr', 'ms', 'my', 'nb-NO',
        'ne-NP', 'nl', 'nn-NO', 'oc', 'pa-IN', 'pl', 'pt-BR', 'pt-PT', 'rm',
        'ro', 'ru', 'scn', 'si', 'sk', 'sl', 'son', 'sq', 'sr', 'sv-SE', 'szl',
        'ta', 'te', 'th', 'tl', 'tr', 'trs', 'uk', 'ur', 'uz', 'vi', 'wo',
        'xh', 'zh-CN', 'zh-TW',
    ]
    ...
    for x in range(0, 400, 5):
        ...
        for locale in locales:
            if previous_day == '':
                ...
                completion = round(100 * float(translated) /
                                   (missing + translated), 2)
            else:
